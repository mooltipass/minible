...
# Debian package
docker exec mc-deb bash /scripts/build_source_emu.sh $VERSION xenial
docker exec mc-deb bash /scripts/build_source_emu.sh $VERSION bionic
docker exec mc-deb bash /scripts/build_source_emu.sh $VERSION disco
docker exec mc-deb bash /scripts/build_source_emu.sh $VERSION eoan
