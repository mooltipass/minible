...
export PROJECT_NAME=minible_emu
...
function make_version()
{
    ...
    echo "#ifndef VERSION__H" > $1/source_code/main_mcu/src/EMU/version.h
    echo "#define VERSION__H" >> $1/source_code/main_mcu/src/version.h
    echo "#define APP_VERSION \"$VERSION\"" >> $1/source_code/main_mcu/src/version.h
    echo "#define APP_TYPE \"$2\"" >> $1/source_code/main_mcu/src/version.h
    if endsWith -testing "$VERSION"; then
        echo "#define APP_RELEASE_TESTING 1" >> $1/source_code/main_mcu/src/version.h
    fi
    echo "#endif" >> $1/source_code/main_mcu/src/version.h

    echo "version.h created"
    cat $1/source_code/main_mcu/src/version.h
}
