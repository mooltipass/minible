...
def main():
	...
	if len(sys.argv) > 1:
		if sys.argv[1] == "sendMonitorFrame":
			...
			# Ask for the info
			packet = mooltipass_device.device.sendHidMessageWaitForAck(mooltipass_device.getPacketForCommand(CMD_ID_SET_DEVICE_SETTINGS, [0x00, 0x00, 0x0f, 0x01, 0x00, 0x09, 0x0a, 0x0f, 0x01, 0x90, 0x01, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]), True)
			if packet["cmd"] == CMD_GET_DEVICE_STATUS:
				packet =  mooltipass_device.device.receiveHidMessage(True)
