...
typedef enum    {RETURN_AUX_STAT_OK, RETURN_AUX_STAT_TIMEOUT, RETURN_AUX_STAT_OK_WITH_BLE, RETURN_AUX_STAT_BLE_ISSUE, RETURN_AUX_STAT_INV_MAIN_MSG, RETURN_AUX_STAT_TOO_MANY_CB} aux_status_return_te;
...
typedef enum    {WAKEUP_REASON_NONE = 0, WAKEUP_REASON_AUX_MCU, WAKEUP_REASON_30M_TIMER, WAKEUP_REASON_OTHER, WAKEUP_REASON_BOOT} platform_wakeup_reason_te;
...
typedef enum    {BUNDLE_UPLOAD_CTR_B1_ID = 1, AUTH_CHALLENGE_CTR_B1_ID = 2, AUTH_RESPONSE_CTR_B1_ID = 3} aes_operation_ctr_b1_purpose_te;
