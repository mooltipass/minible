...
typedef enum    {HID_MSG_RCVD, HID_CANCEL_MSG_RCVD, BL_MSG_RCVD, EVENT_MSG_RCVD, MAIN_MCU_MSG_RCVD, RNG_MSG_RCVD, FIDO2_MSG_RCVD, ERRONEOUS_MSG_RCVD, UNKNOW_MSG_RCVD, NO_MSG_RCVD, HID_REINDEX_BUNDLE_RCVD, BLE_CMD_MSG_RCVD, BLE_BOND_STORE_RCVD, BLE_6PIN_REQ_RCVD} comms_msg_rcvd_te;
typedef enum    {MINI_INPUT_RET_TIMEOUT = -1, MINI_INPUT_RET_NONE = 0, MINI_INPUT_RET_NO = 1, MINI_INPUT_RET_YES = 2, MINI_INPUT_RET_BACK = 3, MINI_INPUT_RET_CARD_REMOVED = 4, MINI_INPUT_RET_CANCELED = 5} mini_input_yes_no_ret_te;
...
typedef enum    {GUI_INFO_DISP_RET_OK = 0, GUI_INFO_DISP_RET_SCROLL, GUI_INFO_DISP_RET_CLICK, GUI_INFO_DISP_RET_CARD_CHANGE, GUI_INFO_DISP_RET_LONG_CLICK, GUI_INFO_DISP_RET_BLE_PAIRED} gui_info_display_ret_te;
typedef enum    {MSG_NO_RESTRICT, MSG_RESTRICT_ALL, MSG_RESTRICT_ALLBUT_BUNDLE, MSG_RESTRICT_ALLBUT_CANCEL, MSG_RESTRICT_ALLBUT_BOND_STORE} msg_restrict_type_te;
...
typedef enum    {WAKEUP_REASON_NONE = 0, WAKEUP_REASON_AUX_MCU, WAKEUP_REASON_20M_TIMER, WAKEUP_REASON_OTHER} platform_wakeup_reason_te;
typedef enum    {ACC_DET_NOTHING, ACC_DET_MOVEMENT, ACC_DET_KNOCK, ACC_INVERT_SCREEN, ACC_NINVERT_SCREEN, ACC_FAILING} acc_detection_te;
