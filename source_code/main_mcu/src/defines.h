...
typedef enum    {GUI_INFO_DISP_RET_OK = 0, GUI_INFO_DISP_RET_SCROLL, GUI_INFO_DISP_RET_CLICK, GUI_INFO_DISP_RET_CARD_CHANGE, GUI_INFO_DISP_RET_LONG_CLICK} gui_info_display_ret_te;
