...
typedef enum    {HID_MSG_RCVD, HID_CANCEL_MSG_RCVD, BL_MSG_RCVD, EVENT_MSG_RCVD, MAIN_MCU_MSG_RCVD, RNG_MSG_RCVD, FIDO2_MSG_RCVD, ERRONEOUS_MSG_RCVD, UNKNOW_MSG_RCVD, NO_MSG_RCVD, HID_REINDEX_BUNDLE_RCVD, BLE_CMD_MSG_RCVD, BLE_BOND_STORE_RCVD} comms_msg_rcvd_te;
