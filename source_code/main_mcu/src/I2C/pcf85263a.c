...
RET_TYPE pcf85263a_init(void)
{
    ...
    /* Battery switch register: enable battery switch, low refresh rate, switching at vth level, 2.8V threshold voltage */
    sercom_i2c_host_write_register_in_device(I2C_SERCOM, PCF85263A_ADDR, 0x26, 0x01);    
