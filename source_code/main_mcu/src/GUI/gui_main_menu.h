...
#define GUI_CAT_ICON_ID         146
#define GUI_FAV_ICON_ID         159
#define GUI_LOGIN_ICON_ID       172
#define GUI_LOCK_ICON_ID        185
#define GUI_OPR_ICON_ID         198
#define GUI_SETTINGS_ICON_ID    211
// Text IDs
