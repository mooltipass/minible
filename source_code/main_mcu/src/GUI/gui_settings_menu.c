...
#include "defines.h"
// Menu layout
const uint16_t operations_settings_pic_ids[] = {GUI_KEYB_LAYOUT_CHANGE_ICON_ID, GUI_CRED_PROMPT_CHANGE_ICON_ID, GUI_PWD_DISP_CHANGE_ICON_ID, GUI_WHEEL_ROT_FLIP_ICON_ID, GUI_BAT_REFRESH_ICON_ID, GUI_LANGUAGE_SWITCH_ICON_ID, GUI_BACK_ICON_ID};
const uint16_t operations_settings_text_ids[] = {GUI_KEYB_LAYOUT_CHANGE_TEXT_ID, GUI_CRED_PROMPT_CHANGE_TEXT_ID, GUI_PWD_DISP_CHANGE_TEXT_ID, GUI_WHEEL_ROT_FLIP_TEXT_ID, GUI_BAT_REFRESH_TEXT_ID, GUI_LANGUAGE_SWITCH_TEXT_ID, GUI_BACK_TEXT_ID};
