...
/*! \fn     utils_uint32_t_to_be_array(uint8_t* array, uint32_t value)
*   \brief  Convert a uint32_t to a big endian array
*   \param  array   The 4 bytes array into which the value should be stored
