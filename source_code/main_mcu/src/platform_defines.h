...
/********************/
    ...
    #define BATTERY_ADC_70PCT_VOLTAGE   (3600)
    #define BATTERY_ADC_60PCT_VOLTAGE   (3554)
    #define BATTERY_ADC_50PCT_VOLTAGE   (3526)
    #define BATTERY_ADC_40PCT_VOLTAGE   (3489)
    #define BATTERY_ADC_30PCT_VOLTAGE   (3462)
    #define BATTERY_ADC_20PCT_VOLTAGE   (3425)
    #define BATTERY_ADC_10PCT_VOLTAGE   (3388)
    #define BATTERY_ADC_OUT_CUTOUT      (3306)
    #define BATTERY_ADC_EMGCY_CUTOUT    (3214)
#endif
