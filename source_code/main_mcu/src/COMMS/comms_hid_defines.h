...
typedef struct
{
    power_consumption_log_t power_consumption_log;
    power_eoc_event_diag_data_t aux_eoc_data;
    uint16_t bandgap_measurement;
} hid_message_bat_diag_info_t;
...
typedef struct
{
    ...
    union
    {
        ...
        hid_message_bat_diag_info_t diag_bat_info_message;
