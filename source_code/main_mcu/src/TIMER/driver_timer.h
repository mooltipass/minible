...
/* Enums */
typedef enum {TIMER_WAIT_FUNCTS = 0, TIMER_TIMEOUT_FUNCTS = 1, TIMER_USER_INTERACTION = 2, TIMER_SCROLLING = 3, TIMER_ANIMATIONS = 4, TIMER_SCREEN = 5, TIMER_CHECK_PASSWORD = 6, TIMER_BATTERY_ANIM = 7, TOTAL_NUMBER_OF_TIMERS} timer_id_te;
