...
void logic_gui_display_login_password_TOTP(child_cred_node_t* child_node)
{
    ...
    {
        uint8_t remaining_secs = logic_encryption_generate_totp(child_node->TOTP.TOTPsecret_ct, child_node->TOTP.TOTPsecretLen, child_node->TOTP.TOTPnumDigits, TOTP_str, LOGIC_GUI_TOTP_STR_LEN);
