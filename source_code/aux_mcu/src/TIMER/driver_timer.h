...
/* Enums */
typedef enum {TIMER_WAIT_FUNCTS = 0, TIMER_TIMEOUT_FUNCTS = 1, TIMER_BT_TYPING_TIMEOUT = 2, TIMER_ADC_WATCHDOG = 3, TIMER_MAIN_MCU_WAKE_DELAY = 4, TIMER_USB_SEND_TIMEOUT = 5, TOTAL_NUMBER_OF_TIMERS} timer_id_te;
