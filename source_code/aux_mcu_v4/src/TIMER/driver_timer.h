...
/* Enums */
typedef enum {TIMER_WAIT_FUNCTS = 0, TIMER_TIMEOUT_FUNCTS = 1, TIMER_BATTERY_TICK = 2, TIMER_BT_TYPING_TIMEOUT = 3, TIMER_ADC_WATCHDOG = 4, TOTAL_NUMBER_OF_TIMERS} timer_id_te;
